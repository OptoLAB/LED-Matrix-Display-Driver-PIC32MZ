...
//INCLUDE BOARD
//-------------------------------------------------------------------
#include <boards/mini32forPIC32MZ.h>
//-------------------------------------------------------------------
//REVISION
//------------------------------------------------------------------
...
#define REFRESH_MODE			(1)
	...
	// 2 - FREERTOS (refresh executed in separate FREERTOS task, requires separate task implementation for refreshDisplay() execution - NOT IMPLEMENTED)
#if (REFRESH_MODE)
    #define REFRESH_RATE        (100)  	  //to low => flickering, to high => slow response
#endif
//-------------------------------------------------------------------
